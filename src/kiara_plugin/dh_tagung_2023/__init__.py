...
"""Top-level package for kiara_plugin.dh_tagung_2023."""
...
KIARA_METADATA = {
    ...
    "description": "Kiara modules for: dh_tagung_2023",
    "references": {
        "source_repo": {
            "desc": "The module package git repository.",
            "url": "https://github.com/DHARPA-Project/kiara_plugin.dh_tagung_2023",
        },
        "documentation": {
            "desc": "The url for the module package documentation.",
            "url": "https://DHARPA-Project.github.io/kiara_plugin.dh_tagung_2023/",
        },
    },
    "tags": ["dh_tagung_2023"],
...
find_modules: KiaraEntryPointItem = (
    find_kiara_modules_under,
    "kiara_plugin.dh_tagung_2023.modules",
)
find_model_classes: KiaraEntryPointItem = (
    find_kiara_model_classes_under,
    "kiara_plugin.dh_tagung_2023.models",
)
find_data_types: KiaraEntryPointItem = (
    find_data_types_under,
    "kiara_plugin.dh_tagung_2023.data_types",
)
find_pipelines: KiaraEntryPointItem = (
    find_pipeline_base_path_for_module,
    "kiara_plugin.dh_tagung_2023.pipelines",
    KIARA_METADATA,
)
